"""Tests for the Shopee Xpress deliveries calendar."""
from datetime import datetime, timezone
from unittest.mock import MagicMock

from custom_components.shopee_xpress.calendar import ShopeeXpressDeliveriesCalendar
...
def _cal(data):
    return ShopeeXpressDeliveriesCalendar(_coordinator(data), _entry())
...
def test_pickup_sets_location():
    cal = _cal([_parcel("A", planned_from="2099-01-01T10:00:00Z", pickup=True, pickup_point="Shopee Xpress Shop")])
    assert cal._events()[0].location == "Shopee Xpress Shop"
